...
class seasonality_form(FlaskForm):
    ...
    season_per = SelectField(
        label="periods",
        validators=[InputRequired()],
        choices=[("Year", "Year"), ("Month", "Month")],
    )
    function = RadioField(
        label="Statistical Test", choices=[("kruskal", "kruskal")], default="kruskal"
    )
...
class trend_form(FlaskForm):
    function = RadioField(
        ...
        choices=[("pymannkendall", "pymannkendall")],
        default="pymannkendall",
    )
...
class stationarity_form(FlaskForm):
    function = RadioField(
        label="Statistical Test", choices=[("adfuller", "adfuller")], default="adfuller"
    )
...
class make_residuals(FlaskForm):
    function = RadioField(
        label="Statistical Test", choices=[("detrend", "detrend")], default="detrend"
    )
